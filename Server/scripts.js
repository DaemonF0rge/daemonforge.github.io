        ...
        try{
            ...
            if (data.status !== undefined){
                ...
                for(mod of data.mods){
                    ...
                    description = description.replace(/\[[Uu][Rr][Ll][=](.*)[\]](.*)\[\/[Uu][Rr][Ll]\]/g, function(x){return x.replace(/\[[Uu][Rr][Ll][=]/, "<a style=\"display: inline;\" target=\"_blank\" href=\"").replace(/\[[\/][Uu][Rr][Ll]\]/, "</a>").replace(/\]/, "\" >")});
